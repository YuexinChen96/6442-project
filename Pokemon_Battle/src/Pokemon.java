...
public class Pokemon implements Serializable {
    ...
    public boolean getGrassAble() {
        return grass_able;
    }

    public void setGrassAble(boolean grass_able) {
        this.grass_able = grass_able;
    }

    public boolean getStoneAble() {
        return stone_able;
    }

    public void setStoneAble(boolean stone_able) {
        this.stone_able = stone_able;
    }
    ...
    public void setWaterAble(boolean water_able) {
        this.water_able = water_able;
    }
